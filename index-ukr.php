    ...
    <div id="header">
		<div class="content">
			...
			<div class="right_sitebar">
				<h2>Вся Украина: (048) 777-44-88</h2>
			</div>
		</div>
	</div>
...
<section class='modul-5' id="module_start_road">
	...
	<div class="content">
		<div class="left_sitebar">
			<ul>
				<li>
					<div class="container img left_sitebar wow slideInLeft">
						<img src="img/icon-m5-1.png" alt="icon-m5-1">
					</div>
					<div class="container txt wow fadeIn">
						<p class="text">Рации <b>Beofeng</b> и <b>Kenwood</b><br />чрезвычайно популярны среди<br />участников страйкбольных игр</p>
					</div>
				</li>
				<li>
					<div class="container img left_sitebar wow slideInLeft" data-wow-delay="0.2s">
						<img src="img/icon-m5-2.png" alt="icon-m5-2">
					</div>
					<div class="container txt wow fadeIn" data-wow-delay="0.3s">
						<p class="text">Крупные компании закупают<br />рации <b>Beofeng</b> для своих<br />сотрудников</p>
					</div>
				</li>
				<li>
					<div class="container img left_sitebar wow slideInLeft" data-wow-delay="0.4s">
						<img src="img/icon-m5-3.png" alt="icon-m5-3">
					</div>
					<div class="container txt wow fadeIn" data-wow-delay="0.6s">
		...
		<div class="container center">
			<ul>
				...
				<li>
 				...
 				<li class="ukr-three">
					<div class="container right_sitebar wow zoomInRight">
						<p class="text">Доставляем<br />Вам товар</p>
					</div>
					<div class="container left_sitebar">
...
<section class='modul-8' id="8">
	<div class="content">
		...
		<div class="container center clear">
			<img src="img/icon-m7-tittle.png" alt="icon-m7-tittle" class="wow pulse animated" data-wow-iteration="8" >
		</div>
		...
		<div class="slider_sert">
			<div class="cont_slider_2">
				<img src="img/foto_3.png" alt="foto_3">
				<p class="text">Приобрели для новой бригады рабочих Baofeng. Сначала прошлись по Сети,
					посмотрели характеристики, почитали отзывы. По параметрам все подходило. Недорого,
					но требования выдерживает. Заказали у ребят рации. Привезли быстро с бесплатной
					доставкой. Работают рации исправно. Покупкой не разочарованы. За что спасибо.</p>
				<p class="text right">Олег <br />г.Одесса</p>
			</div>
			<div class="cont_slider_2">
				<img src="img/foto_4.png" alt="foto_4">
				<p class="text">Играю регулярно в страйкбол. Старая рация из-за погоды (упал в воду) вышла из строя,
					поэтому решил взять что-то более надежное. Выбрал Kenwood F8. Отзывы хорошие. И
					на вид понравилась, характеристики то же хорошие. Заказал через Сеть. Доставили
					быстро, еще и бесплатно. Пользуюсь уже больше года – ни разу не подвела. Для
					страйкбола – самое оно. Все советую.</p>
				<p class="text right">Андрей <br />г.Киев</p>
			</div>
			<div class="cont_slider_2">
				<img src="img/foto-10.png" alt="foto-10">
				<p class="text">У нас собственное агентство по организации шоу программ, концертов, свадеб и т.д. 
					Сотрудников в штате немного, поэтому нужна оперативность в координации действий, тем более, 
					если вдруг что-то пошло не так как запланировано (а это случается частенько). 
					Выбрали рации Kenwood за их надежность и хороший сигнал. Пользуемся уже больше года, все устраивает.</p>
				<p class="text right">Светлана <br />г.Харьков</p>
			</div>
			<div class="cont_slider_2">
				<img src="img/foto-9.png" alt="foto-9">
				<p class="text">У нас есть сбитая туристическая команда. Каждый год выезжаем на новые места на
					дикую природу. Разумеется, жизненно необходима связь. Купили рации Baofeng. Цены
					хорошие. Сигнал хорошо пробивает на требуемое расстояние, да и так надежны.
					</p>
				<p class="text right">Сергей <br />г.Харьков</p>
			</div>
		</div>
	...
	<div class="content">
		<div class="logos">
			...
			<div class="right_sitebar bottom">
				<p class="text">Вся Украина: (048) 777-44-88</p>
			</div>
		</div>
	</div><!--end f_content-->
</footer><!--end footer--> 
